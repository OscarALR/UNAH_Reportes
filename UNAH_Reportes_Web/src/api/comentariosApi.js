...
export async function eliminarTodosLosComentarios(idReporte, token) {
  const response = await apiClient.delete(`/reportes/${idReporte}/comentarios`, { headers: { Authorization: `Bearer ${token}` } });
  return response.data;
}
